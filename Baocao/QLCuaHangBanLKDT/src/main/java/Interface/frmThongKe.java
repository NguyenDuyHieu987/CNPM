...
public class frmThongKe extends javax.swing.JFrame {
     ...
     */
    public frmThongKe(String TK, String MK) {
        initComponents();
        this.TaiKhoan = TK;
        this.MatKhau = MK;
        InsertDataTable();
    ...
    public void InsertDataTable() {
        ...
        tbThongKeDoanhThu.setModel(defaultTableModel);
...
//        tbThongKeDoanhThu.getColumnModel().getColumn(2).setPreferredWidth(200);
        LoadDataTable();
...
//        cbMaPhong.removeAllItems();
        ...
        for (ThongKe thongKe : listthoThongKes) {
            defaultTableModel.addRow(new Object[]{
                ...
                thongKe.getGhiChu(),
                new BigDecimal(thongKe.getTongTien()).longValue(),});
...
//            cbMaPhong.addItem(phong.getMaPhong());
    ...
    private void initComponents() {
        ...
        cbThongKeType = new javax.swing.JComboBox<>();
        ...
        tbThongKeDoanhThu = new javax.swing.JTable();
        ...
        cbThongKeType.setEditable(true);
        cbThongKeType.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        cbThongKeType.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Doanh thu", "Chi tiêu" }));
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(cbThongKeType, 0, 123, Short.MAX_VALUE))
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(cbThongKeType, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        jLabel1.setText("THỐNG KÊ DOANH THU, CHI TIÊU");
        ...
        tbThongKeDoanhThu.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        tbThongKeDoanhThu.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        tbThongKeDoanhThu.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_ALL_COLUMNS);
        tbThongKeDoanhThu.setCellSelectionEnabled(true);
        tbThongKeDoanhThu.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
        tbThongKeDoanhThu.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbThongKeDoanhThuMouseClicked(evt);
            }
        });
        jScrollPane2.setViewportView(tbThongKeDoanhThu);
    ...
    private void tbThongKeDoanhThuMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbThongKeDoanhThuMouseClicked
        // TODO add your handling code here:
        defaultTableModel = (DefaultTableModel) tbThongKeDoanhThu.getModel();
        int row = tbThongKeDoanhThu.getSelectedRow();
    ...
    }//GEN-LAST:event_tbThongKeDoanhThuMouseClicked
        ...
        try {
            if (rdMonth.isSelected()) {
                if (txtMaThongKe.getText().equals("") || txtTenThongKe.getText().equals("") || txtGhiChu.getText().equals("")) {
                    ...
                    int confirm = JOptionPane.showConfirmDialog(null, "Bạn có muốn thống kê doanh thu từ tháng " + spnMonth.getValue() + " năm "
                            + cbYear.getSelectedItem() + " đến tháng " + spnMonthEnd.getValue() + " năm "
                            + cbYearEnd.getSelectedItem() + " không?", "Thông báo", JOptionPane.YES_NO_OPTION);
                    if (confirm == JOptionPane.YES_OPTION) {

                        int Thang = (Integer) spnMonth.getValue();
                        int ThangEnd = (Integer) spnMonthEnd.getValue();
                        int Nam = Integer.valueOf(cbYear.getSelectedItem().toString());
                        int NamEnd = Integer.valueOf(cbYearEnd.getSelectedItem().toString());

                        Double TongTien = 0.0;
                        if (cbThongKeType.getSelectedItem() == "Doanh thu") {
                            TongTien = thongKeController.ThongKeDoanhThu_Thang(Thang, ThangEnd, Nam, NamEnd);
                        } else if (cbThongKeType.getSelectedItem() == "Chi tiêu") {
                            TongTien = thongKeController.ThongKeChiTieu_Thang(Thang, ThangEnd, Nam, NamEnd);
                        }
                ...
                if (txtMaThongKe.getText().equals("") || txtTenThongKe.getText().equals("") || txtGhiChu.getText().equals("")) {
                    ...
                    if (confirm == JOptionPane.YES_OPTION) {
                        ...
                        Double TongTien = 0.0;
                        if (cbThongKeType.getSelectedItem() == "Doanh thu") {
                            TongTien = thongKeController.ThongKeDoanhThu_Nam(Nam, NamEnd);
                        } else if (cbThongKeType.getSelectedItem() == "Chi tiêu") {
                            TongTien = thongKeController.ThongKeChiTieu_Nam(Nam, NamEnd);
                        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmThongKe fThongKeDoanhSo = new frmThongKe();
    ...
    private javax.swing.JComboBox<String> cbThongKeType;
    ...
    private javax.swing.JTable tbThongKeDoanhThu;
